...
-- >> POSITION CHANGED: Moved to the top-right corner of the screen
MainFrame.Position = UDim2.new(1, -340, 0, 20) -- 20px from top, 20px from right
...
-- Minimalist Icon (Updated to a new Lightning Bolt)
local Icon = Instance.new("ImageLabel")
Icon.Size = UDim2.new(0, 28, 0, 28)
Icon.Position = UDim2.new(0.04, 0, 0.5, -14)
Icon.BackgroundTransparency = 1
-- >> ICON CHANGED: Using a new, more reliable asset ID for a minimal lightning bolt
Icon.Image = "rbxassetid://11691889855"
